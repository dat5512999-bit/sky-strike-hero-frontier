(function(ns){
 ...
 const MAPS=Object.freeze({
  classic:Object.freeze({id:'classic',name:'銀葉邊境',visible:false,developmentOnly:true,width:720,height:720,path:classic.path,heroSpawn:{x:350,y:305},roadClearance:55,roadUnits:true}),
  frontier:Object.freeze({id:'frontier',name:'銀葉隘口 · 戰術原型',visible:false,developmentOnly:true,width:1280,height:900,
   ...
   heroSpawn:{x:520,y:250},roadClearance:55,roadUnits:true,
  ...
  beginner:Object.freeze({
   ...
   spawn:{x:36,y:370},gate:{x:1500,y:650},heroSpawn:{x:525,y:470},roadClearance:60,roadUnits:true,
   openingFocus:{x:768,y:490},
   safeArea:{x:40,y:125,width:1460,height:650},
   camera:Object.freeze({minUnitPixels:42,referenceUnitSize:112,maxZoom:2.2}),
