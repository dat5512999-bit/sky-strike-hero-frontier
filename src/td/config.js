(function(ns){
  ...
  ns.config=Object.freeze({
    ...
    buildings:{
      frostCrystal:{"name":"冰晶尖塔","icon":"晶","cost":90,"wood":2,"damage":14,"range":170,"interval":0.85,"frost":25,"color":"#86dbe8","role":"前期 Frost Generator｜穩定 +25 Frost，直接傷害低","attackType":"magic","style":"frost-crystal","faction":"冰原","frostland":true,"storyStatus":"CONCEPT"},
      frostBlizzard:{"name":"暴雪祭壇","icon":"雪","cost":150,"wood":3,"damage":29,"range":160,"interval":1.2,"frost":28,"splash":62,"color":"#a9b9c9","role":"開局清群累寒｜搭冰原狼人守路口；62 範圍各 +28 Frost、逐步減速","attackType":"magic","style":"frost-blizzard","faction":"冰原","frostland":true,"storyStatus":"CONCEPT"},
      frostBallista:{"name":"碎冰重弩","icon":"弩","cost":195,"wood":3,"damage":35,"range":270,"interval":2,"frost":0,"shatter":2.4,"shatterRadius":58,"attackType":"pierce","style":"frost-ballista","color":"#ae9473","role":"長距碎冰｜窗口首擊額外 2.4 倍基礎傷害；無 Frost 產出","faction":"冰原","frostland":true,"storyStatus":"CONCEPT"},
      ...
      frostObelisk:{"name":"霜墓尖碑","icon":"碑","cost":225,"wood":3,"damage":20,"range":180,"interval":1.8,"frost":10,"chain":3,"shatter":1.2,"shatterRadius":55,"color":"#8c92b8","role":"中後期連鎖碎冰｜攻擊三個鄰近敵人，已凍結者各有一次碎冰窗口","attackType":"magic","style":"frost-obelisk","faction":"冰原","frostland":true,"storyStatus":"CONCEPT"},
