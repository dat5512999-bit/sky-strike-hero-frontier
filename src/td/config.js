(function(ns){
  ...
  ns.config=Object.freeze({
    ...
    units:{
      hunter:{name:'王國獵手',icon:'➶',cost:70,wood:1,health:92,armor:1,damage:17,range:150,interval:.68,speed:122,color:'#e6c56c',attackType:'pierce',role:'遠距輕甲清怪'},
      arcanist:{name:'奧術學徒',icon:'✦',cost:85,wood:1,health:72,armor:0,damage:13,range:132,interval:.9,speed:104,color:'#ff8a52',attackType:'magic',splash:42,role:'小範圍魔法'},
      ...
      knight:{name:'日耀騎士',faction:'王國',icon:'槌',cost:128,wood:2,health:168,armor:4,damage:26,range:88,interval:.9,speed:100,color:'#e4bd58',attackType:'chaos',role:'破陣緩擊'},
      ...
      halberdier:{name:'獅徽長戟衛',faction:'王國',icon:'戟',cost:112,wood:2,health:154,armor:3,damage:23,range:100,interval:.94,speed:94,color:'#dfd0a7',attackType:'chaos',role:'長戟緩擊｜第四擊震懾'},
      ...
      dryad:{name:'林裔獵手',faction:'精靈',icon:'鹿',cost:126,wood:2,health:105,armor:1,damage:19,range:156,interval:.79,speed:143,color:'#83d9bd',attackType:'magic',slow:.72,slowTime:1.25,style:'nature',role:'遠距自然緩速'},
      moonblade:{name:'月刃哨兵',faction:'精靈',icon:'刃',cost:116,wood:2,health:125,armor:2,damage:21,range:86,interval:.64,speed:148,color:'#a8c5fa',attackType:'chaos',splash:24,style:'moon',role:'近距旋刃'},
    ...
    buildings:{
      ...
      crypt:{name:'幽骨召喚殿',faction:'亡靈',icon:'☽',cost:180,wood:3,damage:12,range:155,interval:1.3,color:'#bc9aff',attackType:'magic',summonInterval:11,summonCapBase:2,summonDuration:12,summonDamage:11,summonRange:68,summonSpeed:125,summonLeashBonus:55,role:'機動幽魂｜近距追擊'},
      soul:{name:'靈魂收割塔',faction:'暗影',icon:'魂',cost:155,wood:2,damage:24,range:158,interval:1.08,color:'#d283ff',attackType:'magic',chain:2,slow:.88,slowTime:.8,bonusVsSlowed:1.2,role:'連鎖收尾｜緩速追擊'},
      ...
      grove:{name:'翠靈古樹',faction:'精靈',icon:'樹',cost:150,wood:3,damage:22,range:154,interval:1.02,color:'#72dc87',attackType:'magic',splash:34,slow:.76,slowTime:1.1,role:'廣域遲滯｜覆蓋防線'},
      graveyard:{name:'冥燈墓園',faction:'暗影',icon:'墓',cost:165,wood:3,damage:14,range:148,interval:1.16,color:'#a985ed',attackType:'magic',summonInterval:10,summonCapBase:3,summonDuration:26,summonDamage:6,summonRange:146,summonSpeed:72,summonLeashBonus:25,role:'長駐亡靈｜遠程防區'},
      ...
      moonwell:{name:'月泉稜鏡塔',faction:'精靈',icon:'月',cost:160,wood:3,damage:18,range:168,interval:1.08,color:'#a9c8ff',attackType:'magic',chain:2,slow:.82,slowTime:1,role:'連鎖緩速｜多點鋪場'},
      plague:{name:'瘟疫尖碑',faction:'暗影',icon:'疫',cost:150,wood:2,damage:18,range:150,interval:1.18,color:'#8fe45d',attackType:'chaos',splash:38,slow:.76,slowTime:1.5,role:'範圍遲緩｜怪海控場'}
    },
