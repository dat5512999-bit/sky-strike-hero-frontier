(function(ns){
  ...
  class Monster{
    constructor(type,wave,path,modifiers){
      const preset=TYPES[type]||TYPES.grunt,mods=modifiers||{};const earlyWaves=Math.min(Math.max(0,wave-1),14),lateWaves=Math.max(0,wave-15),scale=1+earlyWaves*.105+lateWaves*.07,healthRate=mods.enemyHealth||1;
