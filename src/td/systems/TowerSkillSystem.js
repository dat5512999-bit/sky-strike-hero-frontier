(function(ns){
  ...
  const NAMES={arrow:'穿雲齊射',iceward:'寒鋼凍陣',frost:'冰霜新星',cannon:'熔火重砲',storm:'雷霆連鎖',totem:'祖靈震地',crypt:'幽骨召喚',soul:'靈魂收割',barracks:'軍團齊射',grove:'根脈纏繞',graveyard:'亡魂祝福',ballista:'獅翼貫射',moonwell:'月潮折射',plague:'瘟疫蔓延'};
