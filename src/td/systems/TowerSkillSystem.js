(function(ns){
  ...
  const NAMES={arrow:'穿雲齊射',frost:'冰霜新星',cannon:'熔火重砲',storm:'雷霆連鎖',totem:'祖靈震地',crypt:'幽骨召喚',soul:'靈魂收割',barracks:'軍團齊射',grove:'自然禁錮',graveyard:'亡者徵召'};
  class TowerSkillSystem{
    ...
    static fire(tower,targets,projectiles,summons){
      ...
      if(tower.type==='storm'||tower.type==='soul'||cfg.chain)Object.assign(options,{chain:Math.max(cfg.chain||0,tower.type==='storm'||tower.type==='soul'?rank+1:0),chainRange:95,style:tower.type==='soul'?'spirit':'lightning'});
