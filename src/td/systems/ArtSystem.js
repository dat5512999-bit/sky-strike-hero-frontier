(function(ns){
  'use strict';
  class ArtSystem{
    constructor(){this.background=this.load('assets/td/forest-valley-v1.png');this.towers=this.load('assets/td/towers-atlas-v1.png');this.units=this.load('assets/td/units-atlas-v1.png');this.keep=this.load('assets/td/frontier-keep-v1.png');}
    ...
    drawTower(ctx,type,x,y){if(!this.towers.ready)return false;const columns={arrow:0,frost:1,cannon:2};const column=columns[type];if(column===undefined)return false;const sw=this.towers.width/3;ctx.drawImage(this.towers,column*sw,0,sw,this.towers.height,x-53,y-73,106,106);return true;}
