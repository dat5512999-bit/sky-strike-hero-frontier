(function(ns){
  ...
  const MODES={
    ...
    veteran:{name:'軍團老兵',description:'敵軍更耐打，失誤代價更高。',enemyHealth:1.16,enemySpeed:1.05,enemyDamage:1.22,reward:.98,baseHealth:18,preparation:.85,spawnRate:.9,unitRecovery:{enabled:true,time:16,health:.45,guard:1}},
    calamity:{name:'災厄遠征',description:'高壓進軍與致命 Boss，為熟練玩家準備。',enemyHealth:1.34,enemySpeed:1.1,enemyDamage:1.48,reward:.94,baseHealth:15,preparation:.7,spawnRate:.8,unitRecovery:{enabled:false,time:0,health:0,guard:0}}
  };
