(function(ns){
  ...
  const MODES={
    ...
    veteran:{name:'軍團老兵',description:'敵軍後段成長更快，需持續調整陣線。',enemyHealth:1.65,healthGrowth:.03,enemySpeed:1.08,enemyDamage:1.4,reward:.85,baseHealth:18,preparation:.85,spawnRate:.78,unitRecovery:{enabled:true,time:16,health:.45,guard:1}},
