(function(ns){
  ...
  class BuildSystem{
    ...
    upgrade(economy){if(!this.selected||this.selected.active===false)return false;const base=this.selected.upgradeCost(),cost=this.upgradeCost();if(!cost||!spend(economy,cost))return false;this.selected.upgrade();this.selected.totalSpent-=base.gold-cost.gold;this.applyTowerSupport();return true;}
