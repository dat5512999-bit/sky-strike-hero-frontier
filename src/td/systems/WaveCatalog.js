(function(ns){
  ...
  const WAVES=[
    ...
    {name:'岩甲圍城',hint:'巨獸與赤牙壓近英雄，旗手提高速度',groups:[['brute',10],['raider',4],['commander',4],['warder',6]],reward:[82,1],threat:12},
    ...
    {name:'巨獸攻城列',hint:'巨獸與赤牙考驗定點火力配置',groups:[['brute',14],['raider',4],['commander',4],['healer',4]],reward:[165,2],threat:23},
