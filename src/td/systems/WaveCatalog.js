(function(ns){
  ...
  const WAVES=[
    ...
    {name:'秘法前鋒',hint:'術士後方混入會攻擊守軍的赤牙掠奪者',groups:[['grunt',6],['shaman',5],['raider',2]],reward:[34,1],threat:3},
    ...
    {name:'鋼鐵方陣',hint:'盾衛、岩獸與赤牙重甲需要魔法輸出',groups:[['warder',7],['brute',6],['raider',3]],reward:[59,1],threat:8},
    ...
    {name:'岩甲圍城',hint:'巨獸與赤牙攻擊守軍，旗手提高速度',groups:[['brute',10],['raider',4],['commander',4],['warder',6]],reward:[82,1],threat:12},
    ...
    {name:'巨獸攻城列',hint:'巨獸與赤牙迫使守軍換位補防',groups:[['brute',14],['raider',4],['commander',4],['healer',4]],reward:[165,2],threat:23},
