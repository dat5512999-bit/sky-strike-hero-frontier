(function(ns){
  ...
  FrontierApp.prototype.render=function(){renderWithRelease.call(this);const release=this.root.querySelector('.profile-badge small');if(release)release.textContent='HERO FRONTIER · v0.85.47';};
