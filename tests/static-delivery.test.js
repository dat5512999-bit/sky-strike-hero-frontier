...
test('英雄塔防公開顯示目前程式與平衡資料版本',()=>{const html=fs.readFileSync(path.join(root,'td.html'),'utf8');assert.match(html,/v0\.77\.0/);assert.match(html,/BALANCE E2/);assert.match(html,/CHAPTER SAVE/);});
