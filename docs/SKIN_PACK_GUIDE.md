...
> v0.11 說明：塔防正式美術由 `ArtSystem` 與固定 PNG atlas 管理，規格與生成提示見 `TD_ART_ASSETS.md`；它仍不是可由開始畫面切換的 Skin Pack。

> v0.12 說明：人族 TD 戰場與職業人物採 v2 資產，舊 v1 素材保留作英雄、敵軍及安全備援。職業會改變玩法規則，不可由飛機模式 Skin Registry 覆寫。
