...
5. MP4 尚未交付時，介面顯示附有標題與短敘事的分鏡預覽。可暫停、關閉字幕、切換配樂、按「上一張／下一張」快速跳看分鏡、或跳過；Esc 等同跳過。
...
正式 MP4 與翻譯到位後，仍須驗收影片音畫、實際字幕同步及角色身分保密。MP4 缺席時的原創 Web Audio 氛圍配樂是可關閉的暫行互動配樂，不取代正式作曲、編曲與混音。已交付 Key Frame 已通過瀏覽器解碼驗收；Reference approved 前仍不視為正式角色美術定稿。這些尚未製作的內容不會阻擋目前 Story。
