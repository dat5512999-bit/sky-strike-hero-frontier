...
const CACHE_NAME = 'sky-strike-v0.36.0';
const ASSETS = [
  ...
  './assets/td/enemy-grunt-actions-v1.png', './assets/td/enemy-orc-grunt-actions-v2.png', './assets/td/enemy-runner-actions-v1.png', './assets/td/enemy-brute-actions-v1.png', './assets/td/enemy-shaman-actions-v1.png', './assets/td/enemy-healer-actions-v1.png', './assets/td/enemy-boss-actions-v1.png', './assets/td/faction-towers-v1.png', './assets/td/faction-towers-v2.png', './assets/td/faction-shield-v1.png', './assets/td/faction-knight-v1.png', './assets/td/faction-skeleton-v1.png', './assets/td/faction-dragon-v1.png', './assets/td/faction-treant-v1.png', './assets/td/faction-golem-v1.png', './assets/td/faction-structures-v1.png', './assets/td/war-wolf-actions-v1.png', './assets/td/hero-actions-v1.png', './assets/td/hero-hunter-actions-v2.png', './assets/td/hero-rogue-actions-v2.png', './assets/td/hero-rogue-actions-unarmed-v2.png', './assets/td/rogue-actions-unarmed-v2.png', './assets/td/forest-valley-v1.png', './assets/td/towers-atlas-v1.png', './assets/td/units-atlas-v1.png', './assets/td/frontier-keep-v1.png', './assets/td/human-td-battlefield-v2.png', './assets/td/ranger-actions-v1.png', './assets/td/arcanist-actions-v1.png', './assets/td/rogue-actions-v1.png', './assets/td/items/weapons-atlas-v5.png', './assets/td/items/class-weapons-atlas-v1.png', './assets/td/items/equipment-atlas-v1.png',
